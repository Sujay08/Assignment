...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["weather-weather-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppWeatherWeatherPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppWeatherWeatherRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "WeatherPageRoutingModule", function () {
      return WeatherPageRoutingModule;
    });
    /* harmony import */
    ...
    var _weather_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./weather.page */
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! ./update-weather-modal/update-weather-modal.module */
        "./src/app/weather/update-weather-modal/update-weather-modal.module.ts")).then(function (m) {
          return m.UpdateWeatherModalPageModule;
        });
      }
    }];

    var WeatherPageRoutingModule = function WeatherPageRoutingModule() {
      _classCallCheck(this, WeatherPageRoutingModule);
    };

    WeatherPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppWeatherWeatherModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "WeatherPageModule", function () {
    ...
    var _weather_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./weather-routing.module */
    "./src/app/weather/weather-routing.module.ts");
    /* harmony import */


    var _weather_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./weather.page */
    "./src/app/weather/weather.page.ts");

    var WeatherPageModule = function WeatherPageModule() {
      _classCallCheck(this, WeatherPageModule);
    };

    WeatherPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _weather_routing_module__WEBPACK_IMPORTED_MODULE_5__["WeatherPageRoutingModule"]],
  ...
  /***/
  function srcAppWeatherWeatherPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppWeatherWeatherPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WeatherPage", function () {
      return WeatherPage;
    });
    /* harmony import */
    ...
    var _service_toast_toast_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../service/toast/toast.service */
    "./src/app/service/toast/toast.service.ts");
    /* harmony import */


    var _update_weather_modal_update_weather_modal_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./update-weather-modal/update-weather-modal.page */
    ...
    "./node_modules/@ionic-native/firebase-analytics/__ivy_ngcc__/ngx/index.js"); // import { AngularFireAnalytics } from '@angular/fire/analytics';


    var WeatherPage = /*#__PURE__*/function () {
      function WeatherPage(http, loadingController, fireStore, // private fireAnalytics: AngularFireAnalytics,
      ...
      _createClass(WeatherPage, [{
        ...
        key: "openUpdateWeatherModal",
        value: function openUpdateWeatherModal(newWeatherData) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (update) {
                      var _a;
                      ...
                      if (status.data == true) {
                        // this.checkWeatherOnReturn();
                        _this3.currentWeather = _this3.checkCurrentWeather;
                        localStorage.setItem('temprature', (_a = _this3.currentWeather.current) === null || _a === void 0 ? void 0 : _a.temperature);
                      }
                    });
                    _context2.next = 6;
        ...
        value: function getCityWeather() {
          ...
          var cityLat = this.cityData[this.cityID].lat;
          var cityLon = this.cityData[this.cityID].lon;
          var weatherAPI = 'http://api.weatherstack.com/current?access_key=902d5b3808f367bb354460bb7a3ed2fd&query=' + cityLat + ',' + cityLon;
          this.http.get(weatherAPI).subscribe(function (res) {
            var _a;

            _this4.currentWeather = res;
            _this4.currentWeather.current.temperature = 5;
            localStorage.setItem('temprature', (_a = _this4.currentWeather.current) === null || _a === void 0 ? void 0 : _a.temperature);
          }, function (err) {
            console.log(err);
          });
        }
      }, {
        key: "checkWeatherOnReturn",
        value: function checkWeatherOnReturn() {
          var _this5 = this;

          var cityID = localStorage.getItem('cityID');
          var cityLat = this.cityData[cityID].lat;
          var cityLon = this.cityData[cityID].lon;
          var weatherAPI = 'http://api.weatherstack.com/current?access_key=902d5b3808f367bb354460bb7a3ed2fd&query=' + cityLat + ',' + cityLon;
          this.http.get(weatherAPI).subscribe(function (res) {
            _this5.checkCurrentWeather = res;
            var compareTemprature = parseInt(localStorage.getItem('temprature'));

            if (compareTemprature === _this5.checkCurrentWeather.current.temperature) {
              console.log(typeof compareTemprature, typeof _this5.currentWeather.current.temperature);
              console.log(compareTemprature, _this5.currentWeather.current.temperature);

              _this5.toastService.displayToast('Weather upto date');
            } else {
              _this5.openUpdateWeatherModal(_this5.checkCurrentWeather);
            }
          }, function (err) {
            console.log(err);
          });
        ...
        key: "likeSubmission",
        value: function likeSubmission(status) {
          var _this6 = this;

          this.firebaseAnalytics.logEvent('my_event', {
            status: status
          }).then(function (res) {
            _this6.notSubmitted = false;
            console.log(res);
    ...
    WeatherPage.ctorParameters = function () {
      return [{
    ...
    WeatherPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-weather',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./weather.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/weather/weather.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./weather.page.scss */
      "./src/app/weather/weather.page.scss"))["default"]]
    })], WeatherPage);
    /***/
  }
}]);
