...
/* harmony import */ var _service_toast_toast_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/toast/toast.service */ "./src/app/service/toast/toast.service.ts");
...
let RegisterPage = class RegisterPage {
    constructor(auth, toastService, router) {
        this.auth = auth;
    ...
    register() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.formData.password !== this.formData.cPassword) {
                ...
                try {
                    const res = yield this.auth.createUserWithEmailAndPassword(this.formData.username + '@gmail.com', this.formData.password);
